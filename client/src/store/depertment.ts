  ...
  persist(
    (set, get) => ({
      ...
      deleteDepartment: async (id: string) => {
        ...
        try {
          ...
          set((state) => ({
            ...
            selectedDepartment:
              state.selectedDepartment?._id === id
                ? null
      ...
      fetchSemesters: async (departmentId?: string) => {
        ...
        set({ isLoading: true, message: null });
        try {
          const url = departmentId ? `/semester/${departmentId}` : "/semester";
      ...
      deleteSemester: async (id: string) => {
        ...
        try {
          ...
          set((state) => ({
            ...
            selectedSemester:
              state.selectedSemester?.id === id ? null : state.selectedSemester,
